...
pair<vector<Sensor *>, vector<vector<float>>> ControllerComputation::detectDefectSensorsAndOutliers(const Database &database, const string &startTime, const string &optionalEndTime)
{
